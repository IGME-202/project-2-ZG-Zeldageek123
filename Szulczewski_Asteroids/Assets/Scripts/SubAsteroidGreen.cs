...
public class SubAsteroidGreen : MonoBehaviour
{
    //Camera fields
    ...
    void Start()
    {
        ...
        xDir = Random.Range(GameObject.Find("greenAst1(Clone)").GetComponent<Transform>().position.x * -.5f,
            GameObject.Find("greenAst1(Clone)").GetComponent<Transform>().position.x + .5f);
        while (xDir == 0)
        {
            xDir = Random.Range(GameObject.Find("greenAst1(Clone)").GetComponent<Transform>().position.x - .5f,
            GameObject.Find("greenAst1(Clone)").GetComponent<Transform>().position.x + .5f);
        ...
        yDir = Random.Range(GameObject.Find("greenAst1(Clone)").GetComponent<Transform>().position.y - .5f,
            GameObject.Find("greenAst1(Clone)").GetComponent<Transform>().position.y + .5f);
        while (xDir == 0)
        {
            yDir = Random.Range(GameObject.Find("greenAst1(Clone)").GetComponent<Transform>().position.y - .5f,
            GameObject.Find("greenAst1(Clone)").GetComponent<Transform>().position.y + .5f);
